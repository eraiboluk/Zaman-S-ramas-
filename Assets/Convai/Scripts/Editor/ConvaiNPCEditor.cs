...
namespace Convai.Scripts.Editor
{
    ...
    public class ConvaiNPCEditor : UnityEditor.Editor
    {
        ...
        private void OnEnable()
        {
            ...
            if (!_convaiNPC.gameObject.activeInHierarchy)
            {
                _convaiNPC.gameObject.SetActive(true);
                Logger.Warn(
                    "The GameObject this ConvaiNPC component is attached to was not active. It has been activated.",
